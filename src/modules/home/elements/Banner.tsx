        ...
        <section className="bg-[#f7f9fa] text-black font-Lexend">
            <div className="mx-auto max-w-screen-xl px-2 py-14 lg:flex lg:items-center">
                <div className="mx-auto max-w-3xl text-center">
                    <h1 className="text-4xl bg-gradient-to-r from-green-500 via-blue-500 to-purple-600 bg-clip-text  text-transparent font-extrabold  sm:text-7xl mb-2">
                        Create Emails
                    </h1>
                    ...
                    <p className="mx-auto mt-4 px-5 max-w-xl sm:text-md relaxed font-Lexend text-black ">
                        Digital marketing tools to grow your audience faster and drive revenue smarter.
                    </p>

                    <div className="mt-8 flex flex-wrap justify-center gap-5">
                        <Button className="w-[90%] border tracking-wider border-[#7856ff] bg-[#7856ff] px-12 py-3 text-sm rounded-lg hover:text-black focus:outline-none focus:ring active:text-opacity-75 sm:w-auto h-12">
                            Get Started
                        </Button>
                        <Button className="w-[90%] rounded-lg tracking-wider border border-[#7856ff] px-12 py-3 text-sm  bg-transparent h-12 sm:w-auto">
                            Go To Docs
                        </Button>
